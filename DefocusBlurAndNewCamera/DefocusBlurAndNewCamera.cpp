// DefocusBlurAndNewCamera.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//

#include <iostream>
#include "../MultipleObjectAndCodeClean/hittable.h"
#include "../Metal/material.h"
...
#pragma endregion
    ...
    fullcamera cam(lookfrom, lookat, vup, 20, aspect_ratio, aperture, dist_to_focus);
